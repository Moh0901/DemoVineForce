...
{
    public abstract class DemoVineForceWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static DemoVineForceWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(DemoVineForceWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<DemoVineForceDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<DemoVineForceDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<DemoVineForceDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<DemoVineForceDbContext, Task<T>> func)
        {
            T result;
